    ...
    <div className="bg-gray-950 text-white py-4 centre h-[40vh] box-shadow-2xl">
      <div className='flex-2/5 ml-15 flex flex-col gap-5'>
        ...
        <div className="flex gap-6 text-white text-xl">
         ...
         <a href=""> <i className="fi fi-brands-whatsapp hover:text-green-400 hover:scale-110 transition-transform duration-300 cursor-pointer"></i> </a> 
         <a href="https://github.com/Techie-manan"> <i className="fi fi-brands-github hover:text-gray-400 hover:scale-110 transition-transform duration-300 cursor-pointer"></i> </a> 
         <a href="https://www.linkedin.com/in/manan-aggarwal-3572a3327/"> <i className="fi fi-brands-linkedin hover:text-blue-600 hover:scale-110 transition-transform duration-300 cursor-pointer"></i></a>
         <a href="">  <i className="fi fi-brands-reddit hover:text-orange-500 hover:scale-110 transition-transform duration-300 cursor-pointer"></i></a>
        </div>
        </div >
