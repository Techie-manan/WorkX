...
const services = () => {
  return (
    <div className='centre flex-col z-10 h-fit bg-gray-50'>
      <div className='m-10'>
        <AniOnScroll delay={1}> <h1 className='text-6xl font-bold my-2 '>Home Management,</h1></AniOnScroll>
        <AniOnScroll delay={1}> <h1 className='text-6xl font-bold my-2'>Simplified</h1></AniOnScroll>
        <AniOnScroll delay={1.1}>  <h1 className='text-4xl font-semibold my-5'>Choose
