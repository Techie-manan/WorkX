...
const services = () => {
  return (
    <div className='centre flex-col w-screen h-fit bg-gray-50'>
      <div className='m-10'>
      ...
      <div className="flex w-1/2 h-fit overflow-hidden">
        ...
        <div className="flex-col">
          <div className="servicebox relative bg-blue-200 flex flex-col">
          ...
          <div className="servicebox relative bg-amber-100 flex flex-col">
          ...
          <div className="servicebox relative bg-white flex flex-col">
        ...
        <div className="flex-col">
          ...
          <div className="servicebox bg-gray-200 font-semibold text-xl centre">Our Services save your time and reduces stress letting you focus on what is important.</div>

          <div className="servicebox relative bg-blue-300 flex flex-col">
          ...
          <div className="servicebox relative bg-gray-100 flex flex-col">
          ...
          <div className="servicebox relative bg-pink-100 centre flex-col">
